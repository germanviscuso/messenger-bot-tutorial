...
![Alt text](/../../tree/6e611374891791a5dfc15ed070c0cd1d3de636b5/Demo.gif)
...
1. Create or configure a Facebook App or Page here https://developers.facebook.com/apps/
    ...
    ![Alt text](/../../tree/6e611374891791a5dfc15ed070c0cd1d3de636b5/demo/shot1.jpg)
...
2. In the app go to Messenger tab then click Setup Webhook. Here you will put in the URL of your Heroku server and a token. Make sure to check all the subscription fields. 
    ...
    ![Alt text](/../../tree/6e611374891791a5dfc15ed070c0cd1d3de636b5/demo/shot3.jpg)

3. Get a Page Access Token and save this somewhere. 

    ![Alt text](/../../tree/6e611374891791a5dfc15ed070c0cd1d3de636b5/demo/shot2.jpg)
...
1. Add an API endpoint to index.js to process messages. Remember to also include the token we got earlier. 
    ...
    **Optional, but recommended**: keep your app secrets out of version control!
    ...
    ![Alt text](/../../tree/6e611374891791a5dfc15ed070c0cd1d3de636b5/demo/config_vars.jpg)
    ```bash
...
![Alt text](/../../tree/6e611374891791a5dfc15ed070c0cd1d3de636b5/demo/shot4.jpg)
...
![Alt text](/../../tree/6e611374891791a5dfc15ed070c0cd1d3de636b5/demo/shot5.jpg)
...
Now when you chat with the bot and type 'Generic' you can see this.
   ...
   ![Alt text](/../../tree/6e611374891791a5dfc15ed070c0cd1d3de636b5/demo/shot6.jpg)
